  ...
  module TransactionSets
    module ThirtyFifty
      module Implementations
        ...
        SC832 = b.build(
        "SC", "832", "Price/Sales Catalog",
# =============
# Heading
# =========
          d::TableDef.header("Heading",
            b::Segment(10, s::ST, "Transaction Set Header", r::Required, d::RepeatCount.bounded(1),
              b::Element(e::Required,    "Transaction Set Identifier Code", b::Values("832")),
              b::Element(e::Required,    "Transaction Set Control Number")),

            b::Segment(20, s::BCT, "Beginning Segment for Price/Sales Catalog", r::Required, d::RepeatCount.bounded(1),
              b::Element(e::Required,    "Catalog Purpose Code", b::Values("CP","PC","SC")),
              b::Element(e::Required,    "Catalog Number"),
